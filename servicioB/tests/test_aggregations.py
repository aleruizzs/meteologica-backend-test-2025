...
def test_aggregate_daily_basico():
    rows = [
        ...
        {"date":"2025-10-15","temp_max_c":18.0,"temp_min_c":7.0,"precip_mm":0.0,"cloud_pct":60},
        {"date":"2025-10-16","temp_max_c":17.0,"temp_min_c":7.9,"precip_mm":0.2,"cloud_pct":50},
    ]
    ...
    assert d1["temp_avg_c"] == 12.4 or d1.get("temp_mean_c") == 12.4
    ...
    assert d2["temp_avg_c"] == round((17.0+7.9)/2, 2) or d2.get("temp_mean_c") == round((17.0+7.9)/2, 2)
...
def test_aggregate_rolling7_si_existe():
    ...
    rows = [
        {"date":"2025-10-01","temp_max_c":16.0,"temp_min_c":8.0,"precip_mm":0.0,"cloud_pct":50},
        {"date":"2025-10-02","temp_max_c":17.0,"temp_min_c":9.0,"precip_mm":0.1,"cloud_pct":60},
        {"date":"2025-10-03","temp_max_c":18.0,"temp_min_c":10.0,"precip_mm":0.2,"cloud_pct":70},
        {"date":"2025-10-04","temp_max_c":19.0,"temp_min_c":11.0,"precip_mm":0.3,"cloud_pct":80},
        {"date":"2025-10-05","temp_max_c":20.0,"temp_min_c":12.0,"precip_mm":0.4,"cloud_pct":90},
        {"date":"2025-10-06","temp_max_c":21.0,"temp_min_c":13.0,"precip_mm":0.5,"cloud_pct":60},
        {"date":"2025-10-07","temp_max_c":22.0,"temp_min_c":14.0,"precip_mm":0.6,"cloud_pct":40},
        {"date":"2025-10-08","temp_max_c":23.0,"temp_min_c":15.0,"precip_mm":0.7,"cloud_pct":20},
    ]
    ...
    first = out[0]
    assert "temp_avg7_c" in first and "cloud_avg7_pct" in first and "precip_sum7_mm" in first
